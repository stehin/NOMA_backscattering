...
scenario.phase_off = 1; %Offset?
scenario.packet_length = 1;
scenario.powering = 0; %Da vedere, a noi dovrebbe essere 1 perchè tag con batterie, ma logica inversa
...
%rho = linspace(0,0.9999,5); %Magnitude of the channel gain (21 tesi)
% rho = 0.99999;

% LINK1

l1.sigma_nakagamif = 1;
l1.sigma_nakagamib = 1;
l1.mf_nakagami = 4;
l1.mb_nakagami = 1;
